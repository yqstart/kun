...
- **四套主题**：`Warp 深色`（默认）/ `Dawn 浅色` / `Midnight 深蓝` / `Cyberpunk 霓虹`，每套含独立终端调色板（Catppuccin Mocha 16 色 + xterm 256 色表）
- **动效**：工具栏扫光、渐变 logo、标签选中指示条动画、Toast 滑入淡出、更新状态呼吸灯
